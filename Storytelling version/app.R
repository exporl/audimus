...
server <- function(input, output, session){
  ...
  width_sidebar <- 3
      ...
      if(input$showpanel_v1){
        sidebarLayout(
          ...
          mainPanel(
            ...
            fluidRow(
              column(6, align="center", offset = 3,
                     tags$audio(src = "hello.wav", type = "audio/wav", controls = NA)
              )
            ),
            br(),
            fluidRow(
    ...
    audio_vocoder_F <- reactive({
      if(input$vocoder_geluidInput_F == 1){ load.wave("www/hello.wav") }
      else if(input$vocoder_geluidInput_F == 2) { load.wave("www/boo.wav") }
      else if(input$vocoder_geluidInput_F == 3) { load.wave("www/alarm.wav") }
    })
    ...
    audio_vocoder_BPF <- reactive({
      if(input$vocoder_geluidInput_BPF == 1){ load.wave("www/hello.wav") }
      else if(input$vocoder_geluidInput_BPF == 2) { load.wave("www/boo.wav") }
      else if(input$vocoder_geluidInput_BPF == 3) { load.wave("www/alarm.wav") }
    })
    ...
    audio_vocoder_E <- reactive({
      if(input$vocoder_geluidInput_E == 1){ load.wave("www/hello.wav") }
      else if(input$vocoder_geluidInput_E == 2) { load.wave("www/boo.wav") }
      else if(input$vocoder_geluidInput_E == 3) { load.wave("www/alarm.wav") }
    })
    ...
    audio_vocoder_C <- reactive({
      if(input$vocoder_geluidInput_C == 1){ load.wave("www/hello.wav") }
      else if(input$vocoder_geluidInput_C == 2) { load.wave("www/boo.wav") }
      else if(input$vocoder_geluidInput_C == 3) { load.wave("www/alarm.wav") }
    })
    ...
    audio_vocoder_NBE <- reactive({
      if(input$vocoder_geluidInput_NBE == 1){ load.wave("www/hello.wav") }
      else if(input$vocoder_geluidInput_NBE == 2) { load.wave("www/boo.wav") }
      else if(input$vocoder_geluidInput_NBE == 3) { load.wave("www/alarm.wav") }
    })
    ...
    audio_vocoder_O <- reactive({
      if(input$vocoder_geluidInput_O == 1){ load.wave("www/hello.wav") }
      else if(input$vocoder_geluidInput_O == 2) { load.wave("www/boo.wav") }
      else if(input$vocoder_geluidInput_O == 3) { load.wave("www/alarm.wav") }
    })
    ...
    ## Make audio variable, depending on input
    audio_HA_O <- reactive({
      if(input$hoorapparaat_geluidInput_O == 1){ load.wave("www/hello.wav") }
      else if(input$hoorapparaat_geluidInput_O == 2) { load.wave("www/boo.wav") }
      else if(input$hoorapparaat_geluidInput_O == 3) { load.wave("www/alarm.wav") }
    })
